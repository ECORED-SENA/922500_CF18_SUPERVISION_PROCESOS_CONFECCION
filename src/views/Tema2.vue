...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p.mb-4(data-aos="fade") Se puede definir que la filosofía del KAIZEN se ha implementado en las empresas textiles básicamente en tres escenarios:
            ...
            .bg-blue4.tarjeta.p-4
              .row.align-items-center 
                ...
                .col-md-9
                  ...
                  p.mb-0 El KAIZEN en este escenario se basa en una estrategia transversal para la eliminación de mudas a lo largo del proceso productivo  implementando metodologías y/o técnicas que ayuden a eliminar el desperdicio, mejorándolos tiempos, optimizando la entrega, e incluso mejorando el flujo de dinero.


    h3.t-red(data-aos="fade") Pasos para implementar KAIZEN  
